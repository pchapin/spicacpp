...
namespace common {
    namespace Win32 {
        ...
        //
        // The following function opens (or creates) the specified registry key. It tries to set
        ...
        {
            // First let's be sure the key was opened okay. If not, we didn't get a value.
            // 
            if( error ) return false;
