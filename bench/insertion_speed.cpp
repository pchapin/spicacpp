/*! \file    insertion_speed.cpp
 *  \brief   Measures the performance of insertion sort.
 *  \author  Peter Chapin <spicacality@kelseymountain.org>
 *
 * This file contains a program that measures the performance of bubble sort for various
 * sequence lengths. It is intended to demonstrate the O(n^2) behavior of the algorithm.
 */
...
int main()
{
    ...
    for (sequence_size = 256; sequence_size <= 1 * M; sequence_size *= 2) {
        ...
        stopwatch.start();
        spica::insertion_sort(p, p + sequence_size, std::less<int>());
        stopwatch.stop();
