...
struct sort_test_case tests[] = {
    ...
    {{4, 2, 9, 5, 3, 8, 7, 0}, {0, 2, 3, 4, 5, 7, 8, 9}, 8},

    // Random elements, size 2^n + 1
    {{0, 8, 2, 1, 3, 9, 4, 6, 5}, {0, 1, 2, 3, 4, 5, 6, 8, 9}, 9},

    // Random elements, size 2^n - 1
    {{4, 2, 7, 3, 1, 9, 8}, {1, 2, 3, 4, 7, 8, 9}, 7},

    // Already sorted
    {{1, 3, 5, 7, 9}, {1, 3, 5, 7, 9}, 5},

    // Already reverse sorted
    {{9, 7, 5, 3, 1}, {1, 3, 5, 7, 9}, 5},

    // One pair of duplicate elements
    {{1, 5, 7, 5, 6}, {1, 5, 5, 6, 7}, 5},
    ...
    {{0x00123456, 0x00FEDCBA, 0x00123456, 0x12121212, 0x00120012},
     {0x00120012, 0x00123456, 0x00123456, 0x00FEDCBA, 0x12121212},
     5}};
...
sort_function* test_functions[] = {spica::bubble_sort,
