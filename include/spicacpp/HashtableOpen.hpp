...
namespace spica {
    ...
    template <typename T, typename Hasher = int (*)(const T&)> class HashtableOpen {
    ...
    //
    template <typename T, typename Hasher> HashtableOpen<T, Hasher>::~HashtableOpen()
    {
    ...
    //
    template <typename T, typename Hasher>
    inline typename HashtableOpen<T, Hasher>::size_type HashtableOpen<T, Hasher>::size() const
    {
        return item_count;
    }
    ...
    //
    template <typename T, typename Hasher>
    inline typename HashtableOpen<T, Hasher>::size_type
    ...
    //
    template <typename T, typename Hasher> inline bool HashtableOpen<T, Hasher>::empty() const
    {
        return !size();
    }
    ...
    //
    template <typename T, typename Hasher>
    typename HashtableOpen<T, Hasher>::iterator HashtableOpen<T, Hasher>::begin() const
    {
        iterator result;
    ...
    //
    template <typename T, typename Hasher>
    typename HashtableOpen<T, Hasher>::iterator HashtableOpen<T, Hasher>::end() const
    {
        iterator result;
    ...
    //
    template <typename T, typename Hasher>
    inline typename HashtableOpen<T, Hasher>::value_type&
    ...
    //
    template <typename T, typename Hasher>
    typename HashtableOpen<T, Hasher>::iterator& HashtableOpen<T, Hasher>::iterator::operator++()
    {
        ++current;

        // Now look for a new filled bucket.
        while (current < table->nbuckets) {
            if (!table->freemap[current])
                break;
            ++current;
        }
        return *this;
    ...
    {
        if (table == other.table && current == other.current)
            return true;
        return false;
    }
    ...
    //
    template <typename T, typename Hasher>
    inline bool HashtableOpen<T, Hasher>::iterator::operator!=(const iterator& other) const
    {
        return !(*this == other);
    }
