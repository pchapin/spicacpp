...
namespace spica {
    namespace Windows {
        ...
        RegistryKey::RegistryKey(HKEY top_level_key, const char* key_name) noexcept
        {
            ...
            DWORD disposition;
            LONG open_result =
                RegCreateKeyEx(top_level_key,           // One of the special top level key names.
        ...
        {
            if (!error) {
                RegSetValueEx(key_handle, // Handle of the key.
                              name,       // Name of the value.
                              0,          // Reserved. Must be zero.
                              REG_SZ,     // This value has the type "string."
        ...
        bool RegistryKey::get_value(const char* name, std::string& value)
        {
            ...
            //
            if (RegQueryValueEx(key_handle, // Handle of key to query.
                                name,       // Name of the value.
